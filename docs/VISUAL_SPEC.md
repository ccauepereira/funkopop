# Runner Collectible 3D — Visual Specification V1

**Fonte visual vigente:** Concept Art V1 aprovado, complementado pelas referências originais.  
**Regra:** itens não observáveis ou não aprovados permanecem como pendência; o concept não autoriza criar medidas.

## Confirmado

| Elemento | Especificação visual |
|---|---|
| Personagem | Homem corredor de aparência madura. |
| Cabeça | Dominante em relação ao corpo; volumes limpos de collectible estilizado. |
| Corpo | Pequeno, compacto e amigável; silhueta clara. |
| Cabelo | Curto, branco/grisalho claro, formado por mechas/volumes grandes; não por fios finos. |
...
| Item | Estado |
|---|---|
| Roupa definitiva da pessoa | EM TESTE — a roupa do Concept V1 é provisória. |
| Perfil, costas, nuca e traseira do cabelo | PENDENTE de referência/turnaround. |
| Expressão facial final e detalhes maduros do rosto | PENDENTE de turnaround e QA visual. |
| Escala de impressão | 120 mm e 140 mm são candidatas; nenhuma aprovada. |
| Estratégia de multicolor e divisão física das peças | PENDENTE de engenharia e testes. |
| Conectores | PENDENTE de teste físico; não aparecem no concept. |
