...
**Estado atual:** documentação e Concept Art V1 consolidados. T-010, T-011 e T-012 concluídas; T-013 pronta para início.

## Gate de entrada

O estado atual foi registrado em `PROJECT_SPEC.md`, `VISUAL_SPEC.md`, `DECISIONS.md`, `ENGINEERING_NOTES.md` e `docs/research/README.md`. T-012 está concluída com aprovação humana e T-013 pode começar.
...
| T-013 | Geometric Spec V1 | PRONTA PARA INICIAR | T-012 | Razões e decisões geométricas aprovadas; escala ainda baseada em evidência. |
